...
namespace Vba.Language.Tests.Compiler
{
    public class ModuleStatementTests
    {
        ...
        [InlineData("Private WithEvents Alias As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Alias) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Base As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Base) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Binary As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Binary) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents ClassInit As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier ClassInit) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents ClassTerm As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier ClassTerm) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents CLngLng As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier CLngLng) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Compare As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Compare) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Database As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Database) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents DefLngLng As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier DefLngLng) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Explicit As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Explicit) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Lib As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Lib) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents LongLong As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier LongLong) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Module As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Module) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Object As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Object) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Property As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Property) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents Text As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier Text) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents VB_Invoke_PropertyPutRefVB_MemberFlags As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier VB_Invoke_PropertyPutRefVB_MemberFlags) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        [InlineData("Private WithEvents PtrSafe As Application", "(variableDeclaration Private (variableDclList (witheventsVariableDcl WithEvents (identifier PtrSafe) As (classTypeName (definedTypeExpression (simpleNameExpression (name (untypedName Application))))))))")]
        ...
        [Theory]
        [InlineData("Sub Alias \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Alias) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Base \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Base) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Binary \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Binary) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub ClassInit \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier ClassInit) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub ClassTerm \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier ClassTerm) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub CLngLng \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier CLngLng) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Compare \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Compare) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Database \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Database) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub DefLngLng \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier DefLngLng) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Explicit \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Explicit) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Lib \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Lib) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub LongLong \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier LongLong) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Module \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Module) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Object \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Object) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Property \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Property) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub Text \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier Text) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub VB_Invoke_PropertyPutRefVB_MemberFlags \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier VB_Invoke_PropertyPutRefVB_MemberFlags) \\r\\n End Sub \\r\\n)")]
        [InlineData("Sub PtrSafe \r\nEnd Sub\r\n", "(subroutineDeclaration Sub (identifier PtrSafe) \\r\\n End Sub \\r\\n)")]
        ...
        [Theory]
        [InlineData("Private Const Alias As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Alias) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Base As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Base) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Binary As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Binary) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const ClassInit As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier ClassInit) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const ClassTerm As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier ClassTerm) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const CLngLng As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier CLngLng) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Compare As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Compare) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Database As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Database) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const DefLngLng As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier DefLngLng) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Explicit As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Explicit) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Lib As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Lib) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const LongLong As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier LongLong) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Module As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Module) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Object As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Object) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Property As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Property) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const Text As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier Text) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const VB_Invoke_PropertyPutRefVB_MemberFlags As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier VB_Invoke_PropertyPutRefVB_MemberFlags) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
        [InlineData("Private Const PtrSafe As String = \"\"", "(constDeclaration Private Const (constItemList (constItem (identifier PtrSafe) (asClause (asType As (typeSpec (typeExpression (builtInType (reservedTypeIdentifier String)))))) = (constantExpression (expression (stringExpression \"\"))))))")]
